...
const PrimerProducto = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/agregarProducto', data);
  ...
  return (
    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
      ...
      <br />
        ...
        <p className="text-center">Ya que te acabas de registrar en nuestro sistema, agrega tu primer producto!</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary btn-block mt-3">Agregar Producto</button>
        </form>
      </div>
    </div>
  );
