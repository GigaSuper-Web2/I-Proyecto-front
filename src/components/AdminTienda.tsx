    ...
    const handleSaveProduct = async () => {
        ...
        try {
            if (selectedProduct) {
                ...
                await axios.put(`http://localhost:5000/editarProducto/${selectedProduct.id}`, formData, {
                    headers: {
                ...
                const updatedProducts = products.map((product) =>
                    product._id === selectedProduct.id
                        ? { ...product, nombreProducto: productName, descripcion: productDescription, precio: productPrice, stock: productStock }
                        : product
                );
                ...
                await axios.post('http://localhost:5000/agregarProducto', formData, {
                    headers: {
                        Authorization: `Bearer ${token}`,
                        'Content-Type': 'multipart/form-data',
                    },
